...
from efficentgcn.model_joint.layers import SpatialGraphConvJoint, Temporal_Basic_Layer, Spatial_Graph_Layer, \
...
class EfficientGCN(nn.Layer):
    def __init__(self, data_shape, block_args, fusion_stage, stem_channel, **kwargs):
        ...
        self.input_branches = nn.LayerList([EfficientGCN_Blocks_Joint(
...
if __name__ == "__main__":
    ...
    model = Model('../configs/4branch_eff.yaml', 'JVB')
    y = model(data)
